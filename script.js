async function getCurrentWeatherByCity(city) {
    const data = await fetch(`http://api.weatherapi.com/v1/forecast.json?key=598d3cdfef7f44178ef182129241312&q=${city}&days=1&aqi=no&alerts=no`)
...
async function getForecastByCity(city) {
    const data = await fetch(`http://api.weatherapi.com/v1/forecast.json?key=322446bb5b0a4bb18fd182301241212 &q=${city}&days=1&aqi=no&alerts=no`)
...
// const forecast = [{iconSrc, time, temperature}, {iconSrc, time, temperature}]
